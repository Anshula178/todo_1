...
const FilterList:React.FC<filtereListProps> = ({id,text,completed,priority,handleCompleteToggle,handlePriorityInput,handleDelete,handleEdit,editId}) => {
  return (
    ...
    <div className="flex items-center gap-1">
      ...
      <select
        ...
        onChange={()=>handlePriorityInput(priority)}
      >
